...
web::json::value UsageFeatureNameDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("usage_module_name"))] = ModelBase::toJson(m_Usage_module_name);
    }
...
void UsageFeatureNameDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Usage_module_nameIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("usage_module_name")), m_Usage_module_name));
    }
    if(m_Timestamp_utcIsSet)
    {
