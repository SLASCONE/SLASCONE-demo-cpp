...
web::json::value UsageFeatureNameDto::toJson() const
{
    ...
    if(m_Usage_feature_nameIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("usage_feature_name"))] = ModelBase::toJson(m_Usage_feature_name);
    }
    if(m_Usage_module_name.has_value())
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("usage_module_name"))] = ModelBase::toJson(m_Usage_module_name.get());
    }
...
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("usage_feature_name"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("usage_feature_name")));
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("usage_module_name"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("usage_module_name")));
        if(!fieldValue.is_null())
        {
...
void UsageFeatureNameDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Usage_feature_nameIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("usage_feature_name")), m_Usage_feature_name));
    }
    if(m_Usage_module_name.has_value())
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("usage_module_name")), m_Usage_module_name.get()));
    }
    if(m_Timestamp_utc.has_value())
    {
...
bool UsageFeatureNameDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("usage_feature_name"))))
    {
        utility::string_t refVal_setUsageFeatureName;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("usage_feature_name"))), refVal_setUsageFeatureName );
        setUsageFeatureName(refVal_setUsageFeatureName);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("usage_module_name"))))
    {
        utility::string_t refVal_setUsageModuleName;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("usage_module_name"))), refVal_setUsageModuleName );
        setUsageModuleName(refVal_setUsageModuleName);
    }
...
{
    return m_Usage_module_name.get();
}
...
{
    return m_Usage_module_name.has_value();
}

void UsageFeatureNameDto::unsetUsage_module_name()
{
    m_Usage_module_name.reset();
}
