...
web::json::value LicenseMailDto::toJson() const
{
    ...
    if(m_LicenseKeyIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("licenseKey"))] = ModelBase::toJson(m_LicenseKey);
    }
    ...
    if(m_ToEmailsIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("toEmails"))] = ModelBase::toJson(m_ToEmails);
    }
    if(m_CcEmails.has_value())
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("ccEmails"))] = ModelBase::toJson(m_CcEmails.get());
    }
...
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("licenseKey"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("licenseKey")));
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("toEmails"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("toEmails")));
        if(!fieldValue.is_null())
        {
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("ccEmails"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("ccEmails")));
        if(!fieldValue.is_null())
        {
...
void LicenseMailDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_LicenseKeyIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("licenseKey")), m_LicenseKey));
    }
    if(m_EmailTemplateIdIsSet)
    {
    ...
    if(m_ToEmailsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("toEmails")), m_ToEmails));
    }
    if(m_CcEmails.has_value())
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("ccEmails")), m_CcEmails.get()));
    }
}
...
bool LicenseMailDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("licenseKey"))))
    {
        utility::string_t refVal_setLicenseKey;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("licenseKey"))), refVal_setLicenseKey );
        setLicenseKey(refVal_setLicenseKey);
    }
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("toEmails"))))
    {
        std::vector<utility::string_t> refVal_setToEmails;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("toEmails"))), refVal_setToEmails );
        setToEmails(refVal_setToEmails);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("ccEmails"))))
    {
        std::vector<utility::string_t> refVal_setCcEmails;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("ccEmails"))), refVal_setCcEmails );
        setCcEmails(refVal_setCcEmails);
    }
    return ok;
}
...
std::vector<utility::string_t> LicenseMailDto::getToEmails() const
{
    return m_ToEmails;
}
...
std::vector<utility::string_t> LicenseMailDto::getCcEmails() const
{
    return m_CcEmails.get();
}
