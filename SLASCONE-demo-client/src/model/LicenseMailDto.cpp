...
web::json::value LicenseMailDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("ccEmails"))] = ModelBase::toJson(m_CcEmails);
    }
...
void LicenseMailDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_CcEmailsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("ccEmails")), m_CcEmails));
    }
}
