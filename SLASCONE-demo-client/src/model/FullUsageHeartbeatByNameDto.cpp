...
web::json::value FullUsageHeartbeatByNameDto::toJson() const
{
    ...
    if(m_Create_usage_feature_if_not_existsIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("create_usage_feature_if_not_exists"))] = ModelBase::toJson(m_Create_usage_feature_if_not_exists);
    }
    if(m_Create_usage_module_if_not_existsIsSet)
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("create_usage_module_if_not_exists"))] = ModelBase::toJson(m_Create_usage_module_if_not_exists);
    }
...
bool FullUsageHeartbeatByNameDto::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("create_usage_feature_if_not_exists"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("create_usage_feature_if_not_exists")));
        if(!fieldValue.is_null())
        {
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("create_usage_module_if_not_exists"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("create_usage_module_if_not_exists")));
        if(!fieldValue.is_null())
        {
...
void FullUsageHeartbeatByNameDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Create_usage_feature_if_not_existsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("create_usage_feature_if_not_exists")), m_Create_usage_feature_if_not_exists));
    }
    if(m_Create_usage_module_if_not_existsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("create_usage_module_if_not_exists")), m_Create_usage_module_if_not_exists));
    }
}
...
bool FullUsageHeartbeatByNameDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("create_usage_feature_if_not_exists"))))
    {
        bool refVal_setCreateUsageFeatureIfNotExists;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("create_usage_feature_if_not_exists"))), refVal_setCreateUsageFeatureIfNotExists );
        setCreateUsageFeatureIfNotExists(refVal_setCreateUsageFeatureIfNotExists);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("create_usage_module_if_not_exists"))))
    {
        bool refVal_setCreateUsageModuleIfNotExists;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("create_usage_module_if_not_exists"))), refVal_setCreateUsageModuleIfNotExists );
        setCreateUsageModuleIfNotExists(refVal_setCreateUsageModuleIfNotExists);
    }
    return ok;
}
...
utility::string_t FullUsageHeartbeatByNameDto::getUserId() const
{
    return m_User_id.get();
}


void FullUsageHeartbeatByNameDto::setUserId(const utility::string_t& value)
{
    m_User_id = value;
}

bool FullUsageHeartbeatByNameDto::userIdIsSet() const
{
    return m_User_id.has_value();
}

void FullUsageHeartbeatByNameDto::unsetUser_id()
{
    m_User_id.reset();
}
std::vector<std::shared_ptr<UsageFeatureNameDto>> FullUsageHeartbeatByNameDto::getUsageHeartbeat() const
{
