...
web::json::value DeviceLicenseAssignmentDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("device_name"))] = ModelBase::toJson(m_Device_name);
    }
    if(m_Device_descriptionIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("device_description"))] = ModelBase::toJson(m_Device_description);
    }
    if(m_Token_keyIsSet)
    {   
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("device_analytical_heartbeats"))] = ModelBase::toJson(m_Device_analytical_heartbeats);
    }
    if(m_Software_versionIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("software_version"))] = ModelBase::toJson(m_Software_version);
    }
    if(m_Operating_systemIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("operating_system"))] = ModelBase::toJson(m_Operating_system);
    }
...
void DeviceLicenseAssignmentDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Device_nameIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("device_name")), m_Device_name));
    }
    if(m_Device_descriptionIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("device_description")), m_Device_description));
    }
    if(m_Token_keyIsSet)
    {
    ...
    if(m_Device_analytical_heartbeatsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("device_analytical_heartbeats")), m_Device_analytical_heartbeats));
    }
    if(m_Software_versionIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("software_version")), m_Software_version));
    }
    if(m_Operating_systemIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("operating_system")), m_Operating_system));
    }
    if(m_Tag_assignmentsIsSet)
    {
