...
utility::string_t AddHeartbeatDto::getUserId() const
{
    return m_User_id.get();
}


void AddHeartbeatDto::setUserId(const utility::string_t& value)
{
    m_User_id = value;
}

bool AddHeartbeatDto::userIdIsSet() const
{
    return m_User_id.has_value();
}

void AddHeartbeatDto::unsetUser_id()
{
    m_User_id.reset();
}
