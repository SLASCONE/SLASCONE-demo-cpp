...
ValidateLicenseDto::ValidateLicenseDto()
{
...
void ValidateLicenseDto::validate()
{
    // TODO: implement validation
}

web::json::value ValidateLicenseDto::toJson() const
{
...
bool ValidateLicenseDto::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ValidateLicenseDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ValidateLicenseDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ValidateLicenseDto::getLicenseKey() const
{
    return m_License_key;
}


void ValidateLicenseDto::setLicenseKey(const utility::string_t& value)
{
    m_License_key = value;
    m_License_keyIsSet = true;
}

bool ValidateLicenseDto::licenseKeyIsSet() const
{
    return m_License_keyIsSet;
}

void ValidateLicenseDto::unsetLicense_key()
{
    m_License_keyIsSet = false;
}
