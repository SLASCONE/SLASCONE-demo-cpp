...
web::json::value DataExchangeAddOrUpdateCustomerContactDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("mobil"))] = ModelBase::toJson(m_Mobil);
    }
    if(m_LanguageIsSet)
    {   
...
void DataExchangeAddOrUpdateCustomerContactDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_MobilIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("mobil")), m_Mobil));
    }
    if(m_LanguageIsSet)
    {
