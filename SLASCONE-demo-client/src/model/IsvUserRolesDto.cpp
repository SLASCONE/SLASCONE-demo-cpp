...
web::json::value IsvUserRolesDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("isvName"))] = ModelBase::toJson(m_IsvName);
    }
    if(m_UserIdIsSet)
    {   
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("resellerPortalRoles"))] = ModelBase::toJson(m_ResellerPortalRoles);
    }
    if(m_CustomerPortalRolesIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("customerPortalRoles"))] = ModelBase::toJson(m_CustomerPortalRoles);
    }
...
void IsvUserRolesDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_IsvNameIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("isvName")), m_IsvName));
    }
    if(m_UserIdIsSet)
    {
    ...
    if(m_ResellerPortalRolesIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("resellerPortalRoles")), m_ResellerPortalRoles));
    }
    if(m_CustomerPortalRolesIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("customerPortalRoles")), m_CustomerPortalRoles));
    }
}
