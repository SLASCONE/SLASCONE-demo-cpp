...
double ConsumptionHeartbeatDto::getBalance() const
{
    return m_Balance.get();
}

void ConsumptionHeartbeatDto::setBalance(double value)
{
    m_Balance = value;
}

bool ConsumptionHeartbeatDto::balanceIsSet() const
{
    return m_Balance.has_value();
}

void ConsumptionHeartbeatDto::unsetBalance()
{
    m_Balance.reset();
}
