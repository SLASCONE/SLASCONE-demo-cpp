...
web::json::value LicenseFilterDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("key_search"))] = ModelBase::toJson(m_Key_search);
    }
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("customer_number_filter"))] = ModelBase::toJson(m_Customer_number_filter);
    }
    if(m_Customer_type_filterIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("customer_type_filter"))] = ModelBase::toJson(m_Customer_type_filter);
    }
    if(m_Reseller_type_filterIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("reseller_type_filter"))] = ModelBase::toJson(m_Reseller_type_filter);
    }
    if(m_Template_filterIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("template_filter"))] = ModelBase::toJson(m_Template_filter);
    }
    if(m_License_type_filterIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("license_type_filter"))] = ModelBase::toJson(m_License_type_filter);
    }
    if(m_Operating_system_filterIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("operating_system_filter"))] = ModelBase::toJson(m_Operating_system_filter);
    }
    if(m_Software_version_filterIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("software_version_filter"))] = ModelBase::toJson(m_Software_version_filter);
    }
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("feature_filter"))] = ModelBase::toJson(m_Feature_filter);
    }
    if(m_Is_feature_activeIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("is_feature_active"))] = ModelBase::toJson(m_Is_feature_active);
    }
    if(m_Date_filterIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("date_filter"))] = ModelBase::toJson(m_Date_filter);
    }
    if(m_Date_filter_modeIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("date_filter_mode"))] = ModelBase::toJson(m_Date_filter_mode);
    }
    if(m_Is_normal_tokenIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("is_normal_token"))] = ModelBase::toJson(m_Is_normal_token);
    }
    if(m_Is_goodwill_tokenIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("is_goodwill_token"))] = ModelBase::toJson(m_Is_goodwill_token);
    }
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("group_count_filter"))] = ModelBase::toJson(m_Group_count_filter);
    }
    if(m_Group_count_modeIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("group_count_mode"))] = ModelBase::toJson(m_Group_count_mode);
    }
    if(m_Sort_typeIsSet)
    {   
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("license_tag_filter"))] = ModelBase::toJson(m_License_tag_filter);
    }
    if(m_Token_tag_filterIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("token_tag_filter"))] = ModelBase::toJson(m_Token_tag_filter);
    }
    if(m_Customer_tag_filterIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("customer_tag_filter"))] = ModelBase::toJson(m_Customer_tag_filter);
    }
...
void LicenseFilterDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Key_searchIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("key_search")), m_Key_search));
    }
    if(m_Product_filterIsSet)
    {
    ...
    if(m_Customer_number_filterIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("customer_number_filter")), m_Customer_number_filter));
    }
    if(m_Customer_type_filterIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("customer_type_filter")), m_Customer_type_filter));
    }
    if(m_Reseller_type_filterIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("reseller_type_filter")), m_Reseller_type_filter));
    }
    if(m_Template_filterIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("template_filter")), m_Template_filter));
    }
    if(m_License_type_filterIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("license_type_filter")), m_License_type_filter));
    }
    if(m_Operating_system_filterIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("operating_system_filter")), m_Operating_system_filter));
    }
    if(m_Software_version_filterIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("software_version_filter")), m_Software_version_filter));
    }
    if(m_Is_software_version_validIsSet)
    {
    ...
    if(m_Feature_filterIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("feature_filter")), m_Feature_filter));
    }
    if(m_Is_feature_activeIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("is_feature_active")), m_Is_feature_active));
    }
    if(m_Date_filterIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("date_filter")), m_Date_filter));
    }
    if(m_Date_filter_modeIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("date_filter_mode")), m_Date_filter_mode));
    }
    if(m_Is_normal_tokenIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("is_normal_token")), m_Is_normal_token));
    }
    if(m_Is_goodwill_tokenIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("is_goodwill_token")), m_Is_goodwill_token));
    }
    if(m_Is_group_validIsSet)
    {
    ...
    if(m_Group_count_modeIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("group_count_mode")), m_Group_count_mode));
    }
    if(m_Sort_typeIsSet)
    {
    ...
    if(m_License_tag_filterIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("license_tag_filter")), m_License_tag_filter));
    }
    if(m_Token_tag_filterIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("token_tag_filter")), m_Token_tag_filter));
    }
    if(m_Customer_tag_filterIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("customer_tag_filter")), m_Customer_tag_filter));
    }
    if(m_Analytical_field_filterIsSet)
    {
