...
web::json::value LookupDto::toJson() const
{
    ...
    if(m_Legacy_key.has_value())
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("legacy_key"))] = ModelBase::toJson(m_Legacy_key.get());
    }
...
bool LookupDto::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("legacy_key"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("legacy_key")));
        if(!fieldValue.is_null())
        {
...
void LookupDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Legacy_key.has_value())
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("legacy_key")), m_Legacy_key.get()));
    }
}
...
bool LookupDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("legacy_key"))))
    {
        utility::string_t refVal_setLegacyKey;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("legacy_key"))), refVal_setLegacyKey );
        setLegacyKey(refVal_setLegacyKey);
    }
    return ok;
}
