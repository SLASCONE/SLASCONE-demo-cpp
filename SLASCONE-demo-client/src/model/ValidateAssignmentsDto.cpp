...
web::json::value ValidateAssignmentsDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("customerTypeId"))] = ModelBase::toJson(m_CustomerTypeId);
    }
    if(m_LicenseTypeIdIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("licenseTypeId"))] = ModelBase::toJson(m_LicenseTypeId);
    }
...
void ValidateAssignmentsDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_CustomerTypeIdIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("customerTypeId")), m_CustomerTypeId));
    }
    if(m_LicenseTypeIdIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("licenseTypeId")), m_LicenseTypeId));
    }
}
