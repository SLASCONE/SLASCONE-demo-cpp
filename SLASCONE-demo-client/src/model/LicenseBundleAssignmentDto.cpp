...
web::json::value LicenseBundleAssignmentDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("license_description"))] = ModelBase::toJson(m_License_description);
    }
    if(m_License_template_nameIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("license_template_name"))] = ModelBase::toJson(m_License_template_name);
    }
...
void LicenseBundleAssignmentDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_License_descriptionIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("license_description")), m_License_description));
    }
    if(m_License_template_nameIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("license_template_name")), m_License_template_name));
    }
    if(m_Product_idIsSet)
    {
