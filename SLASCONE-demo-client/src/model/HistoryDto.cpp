...
web::json::value HistoryDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("new_value"))] = ModelBase::toJson(m_New_value);
    }
    if(m_ActionIsSet)
    {   
...
void HistoryDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_New_valueIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("new_value")), m_New_value));
    }
    if(m_ActionIsSet)
    {
