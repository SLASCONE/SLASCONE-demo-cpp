...
web::json::value CustomerFilterDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("search_text"))] = ModelBase::toJson(m_Search_text);
    }
    if(m_Plz_queryIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("plz_query"))] = ModelBase::toJson(m_Plz_query);
    }
    if(m_Customer_typesIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("customer_types"))] = ModelBase::toJson(m_Customer_types);
    }
    if(m_Reseller_typesIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("reseller_types"))] = ModelBase::toJson(m_Reseller_types);
    }
    if(m_TagsIsSet)
    {   
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("start_character"))] = ModelBase::toJson(m_Start_character);
    }
    if(m_Sort_typeIsSet)
    {   
...
void CustomerFilterDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Search_textIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("search_text")), m_Search_text));
    }
    if(m_Plz_queryIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("plz_query")), m_Plz_query));
    }
    if(m_Customer_typesIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("customer_types")), m_Customer_types));
    }
    if(m_Reseller_typesIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("reseller_types")), m_Reseller_types));
    }
    if(m_TagsIsSet)
    {
    ...
    if(m_Start_characterIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("start_character")), m_Start_character));
    }
    if(m_Sort_typeIsSet)
    {
