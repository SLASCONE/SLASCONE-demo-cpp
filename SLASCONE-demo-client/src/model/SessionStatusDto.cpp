...
web::json::value SessionStatusDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("session_created_date"))] = ModelBase::toJson(m_Session_created_date);
    }
    if(m_Session_modified_dateIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("session_modified_date"))] = ModelBase::toJson(m_Session_modified_date);
    }
...
void SessionStatusDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Session_created_dateIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("session_created_date")), m_Session_created_date));
    }
    if(m_Session_modified_dateIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("session_modified_date")), m_Session_modified_date));
    }
    if(m_Max_open_session_countIsSet)
    {
