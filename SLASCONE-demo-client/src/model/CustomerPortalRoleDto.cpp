...
web::json::value CustomerPortalRoleDto::toJson() const
{
    ...
    if(m_CustomerPortalRoleIdIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("customerPortalRoleId"))] = ModelBase::toJson(m_CustomerPortalRoleId);
    }
...
bool CustomerPortalRoleDto::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("customerPortalRoleId"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("customerPortalRoleId")));
        if(!fieldValue.is_null())
        {
...
void CustomerPortalRoleDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_CustomerPortalRoleIdIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("customerPortalRoleId")), m_CustomerPortalRoleId));
    }
}
...
bool CustomerPortalRoleDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("customerPortalRoleId"))))
    {
        utility::string_t refVal_setCustomerPortalRoleId;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("customerPortalRoleId"))), refVal_setCustomerPortalRoleId );
        setCustomerPortalRoleId(refVal_setCustomerPortalRoleId);
    }
    return ok;
}
