...
web::json::value ConsumptionHeartbeatLazyLoadDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("consumption_heartbeats"))] = ModelBase::toJson(m_Consumption_heartbeats);
    }
    if(m_Max_countIsSet)
    {   
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("aggregate_value"))] = ModelBase::toJson(m_Aggregate_value);
    }
...
void ConsumptionHeartbeatLazyLoadDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Consumption_heartbeatsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("consumption_heartbeats")), m_Consumption_heartbeats));
    }
    if(m_Max_countIsSet)
    {
    ...
    if(m_Aggregate_valueIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("aggregate_value")), m_Aggregate_value));
    }
}
