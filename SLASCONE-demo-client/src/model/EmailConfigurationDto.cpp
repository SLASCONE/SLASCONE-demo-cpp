...
web::json::value EmailConfigurationDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("from_email"))] = ModelBase::toJson(m_From_email);
    }
    if(m_PasswordIsSet)
    {   
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("to_email"))] = ModelBase::toJson(m_To_email);
    }
    if(m_Smtp_clientIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("smtp_client"))] = ModelBase::toJson(m_Smtp_client);
    }
    if(m_Smtp_portIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("smtp_port"))] = ModelBase::toJson(m_Smtp_port);
    }
    if(m_Acs_sender_domainIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("acs_sender_domain"))] = ModelBase::toJson(m_Acs_sender_domain);
    }
    if(m_Acs_sender_usernameIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("acs_sender_username"))] = ModelBase::toJson(m_Acs_sender_username);
    }
...
void EmailConfigurationDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_From_emailIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("from_email")), m_From_email));
    }
    if(m_PasswordIsSet)
    {
    ...
    if(m_To_emailIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("to_email")), m_To_email));
    }
    if(m_Smtp_clientIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("smtp_client")), m_Smtp_client));
    }
    if(m_Smtp_portIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("smtp_port")), m_Smtp_port));
    }
    if(m_Acs_sender_domainIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("acs_sender_domain")), m_Acs_sender_domain));
    }
    if(m_Acs_sender_usernameIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("acs_sender_username")), m_Acs_sender_username));
    }
    if(m_Created_date_utcIsSet)
    {
