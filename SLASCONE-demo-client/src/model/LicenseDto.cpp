...
web::json::value LicenseDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("license_limitations"))] = ModelBase::toJson(m_License_limitations);
    }
    if(m_License_constrained_variablesIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("license_constrained_variables"))] = ModelBase::toJson(m_License_constrained_variables);
    }
    if(m_License_variablesIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("license_variables"))] = ModelBase::toJson(m_License_variables);
    }
    if(m_License_users_groupsIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("license_users_groups"))] = ModelBase::toJson(m_License_users_groups);
    }
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("prioritized_software_release"))] = ModelBase::toJson(m_Prioritized_software_release);
    }
    if(m_Mail_logsIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("mail_logs"))] = ModelBase::toJson(m_Mail_logs);
    }
    if(m_Client_idIsSet)
    {   
...
void LicenseDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_License_limitationsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("license_limitations")), m_License_limitations));
    }
    if(m_License_constrained_variablesIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("license_constrained_variables")), m_License_constrained_variables));
    }
    if(m_License_variablesIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("license_variables")), m_License_variables));
    }
    if(m_License_users_groupsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("license_users_groups")), m_License_users_groups));
    }
    if(m_License_usersIsSet)
    {
    ...
    if(m_Prioritized_software_releaseIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("prioritized_software_release")), m_Prioritized_software_release));
    }
    if(m_Mail_logsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("mail_logs")), m_Mail_logs));
    }
    if(m_Client_idIsSet)
    {
