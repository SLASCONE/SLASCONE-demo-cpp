...
bool ProblemDetails::fromJson(const web::json::value& val)
{
    ...
    if(val.is_object())
    {
        for(const auto& item : val.as_object())
        {
            ...
            if(item.first == utility::conversions::to_string_t(_XPLATSTR("detail"))) continue;
            if(item.first == utility::conversions::to_string_t(_XPLATSTR("instance"))) continue;
...
std::map<utility::string_t, web::json::value> ProblemDetails::getAdditionalProperties() const
{
    return m_AdditionalProperties;
}

void ProblemDetails::setAdditionalProperties(const std::map<utility::string_t, web::json::value>& value)
{
    m_AdditionalProperties = value;
    m_AdditionalPropertiesIsSet = true;
}

void ProblemDetails::addAdditionalProperty(const utility::string_t& key, const web::json::value& value)
{
    m_AdditionalProperties[key] = value;
    m_AdditionalPropertiesIsSet = true;
}

bool ProblemDetails::additionalPropertiesIsSet() const
{
    return m_AdditionalPropertiesIsSet;
}

void ProblemDetails::unsetAdditionalProperties()
{
