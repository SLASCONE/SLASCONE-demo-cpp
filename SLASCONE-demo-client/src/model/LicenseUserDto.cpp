...
web::json::value LicenseUserDto::toJson() const
{
    ...
    if(m_Active_sessions.has_value())
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("active_sessions"))] = ModelBase::toJson(m_Active_sessions.get());
    }
    if(m_License_user_group_id.has_value())
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("license_user_group_id"))] = ModelBase::toJson(m_License_user_group_id.get());
    }
...
bool LicenseUserDto::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("license_user_group_id"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("license_user_group_id")));
        if(!fieldValue.is_null())
        {
...
void LicenseUserDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Active_sessions.has_value())
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("active_sessions")), m_Active_sessions.get()));
    }
    if(m_License_user_group_id.has_value())
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("license_user_group_id")), m_License_user_group_id.get()));
    }
}
...
bool LicenseUserDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("license_user_group_id"))))
    {
        utility::string_t refVal_setLicenseUserGroupId;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("license_user_group_id"))), refVal_setLicenseUserGroupId );
        setLicenseUserGroupId(refVal_setLicenseUserGroupId);
    }
    return ok;
}
...
std::vector<std::shared_ptr<SessionDto>> LicenseUserDto::getActiveSessions() const
{
    return m_Active_sessions.get();
}
...
{
    return m_License_user_group_id.has_value();
}

void LicenseUserDto::unsetLicense_user_group_id()
{
    m_License_user_group_id.reset();
}
