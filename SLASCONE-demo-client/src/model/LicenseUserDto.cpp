...
web::json::value LicenseUserDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("license_user_group_id"))] = ModelBase::toJson(m_License_user_group_id);
    }
...
void LicenseUserDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_License_user_group_idIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("license_user_group_id")), m_License_user_group_id));
    }
}
