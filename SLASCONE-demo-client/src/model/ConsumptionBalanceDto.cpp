...
web::json::value ConsumptionBalanceDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("reset_period_days"))] = ModelBase::toJson(m_Reset_period_days);
    }
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("next_reset_date_utc"))] = ModelBase::toJson(m_Next_reset_date_utc);
    }
...
void ConsumptionBalanceDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Reset_period_daysIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("reset_period_days")), m_Reset_period_days));
    }
    if(m_Consumption_balance_modeIsSet)
    {
    ...
    if(m_Next_reset_date_utcIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("next_reset_date_utc")), m_Next_reset_date_utc));
    }
}
