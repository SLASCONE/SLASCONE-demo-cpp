...
web::json::value ConsumptionBalanceDto::toJson() const
{
    ...
    if(m_Assignment_id.has_value())
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("assignment_id"))] = ModelBase::toJson(m_Assignment_id.get());
    }
    if(m_License_id.has_value())
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("license_id"))] = ModelBase::toJson(m_License_id.get());
    }
    ...
    if(m_Reset_modeIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("reset_mode"))] = ModelBase::toJson(m_Reset_mode);
    }
    if(m_Reset_period_days.has_value())
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("reset_period_days"))] = ModelBase::toJson(m_Reset_period_days.get());
    }
...
bool ConsumptionBalanceDto::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("reset_mode"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("reset_mode")));
        if(!fieldValue.is_null())
        {
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("reset_period_days"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("reset_period_days")));
        if(!fieldValue.is_null())
        {
...
void ConsumptionBalanceDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Assignment_id.has_value())
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("assignment_id")), m_Assignment_id.get()));
    }
    if(m_License_id.has_value())
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("license_id")), m_License_id.get()));
    }
    if(m_Limitation_idIsSet)
    {
    ...
    if(m_Reset_modeIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("reset_mode")), m_Reset_mode));
    }
    if(m_Reset_period_days.has_value())
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("reset_period_days")), m_Reset_period_days.get()));
    }
    if(m_Consumption_balance_modeIsSet)
    {
...
bool ConsumptionBalanceDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("reset_mode"))))
    {
        std::shared_ptr<ConsumptionResetPeriod> refVal_setResetMode;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("reset_mode"))), refVal_setResetMode );
        setResetMode(refVal_setResetMode);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("reset_period_days"))))
    {
        int32_t refVal_setResetPeriodDays;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("reset_period_days"))), refVal_setResetPeriodDays );
        setResetPeriodDays(refVal_setResetPeriodDays);
    }
...
double ConsumptionBalanceDto::getBalance() const
{
    return m_Balance;
}

void ConsumptionBalanceDto::setBalance(double value)
{
    m_Balance = value;
    m_BalanceIsSet = true;
}

bool ConsumptionBalanceDto::balanceIsSet() const
{
    return m_BalanceIsSet;
}

void ConsumptionBalanceDto::unsetBalance()
{
    m_BalanceIsSet = false;
}
...
{
    return m_Reset_period_days.get();
}
...
{
    return m_Reset_period_days.has_value();
}

void ConsumptionBalanceDto::unsetReset_period_days()
{
    m_Reset_period_days.reset();
}
