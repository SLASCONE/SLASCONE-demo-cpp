...
web::json::value TemplateDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("goodwill_token_limit"))] = ModelBase::toJson(m_Goodwill_token_limit);
    }
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("license_type_id"))] = ModelBase::toJson(m_License_type_id);
    }
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("free_ride"))] = ModelBase::toJson(m_Free_ride);
    }
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("heartbeat_sampling_rate"))] = ModelBase::toJson(m_Heartbeat_sampling_rate);
    }
...
void TemplateDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Goodwill_token_limitIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("goodwill_token_limit")), m_Goodwill_token_limit));
    }
    if(m_Floating_token_limitIsSet)
    {
    ...
    if(m_License_type_idIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("license_type_id")), m_License_type_id));
    }
    if(m_License_typeIsSet)
    {
    ...
    if(m_Free_rideIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("free_ride")), m_Free_ride));
    }
    if(m_Client_typeIsSet)
    {
    ...
    if(m_Heartbeat_sampling_rateIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("heartbeat_sampling_rate")), m_Heartbeat_sampling_rate));
    }
}
