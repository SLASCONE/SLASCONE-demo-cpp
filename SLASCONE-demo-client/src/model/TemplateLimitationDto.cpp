...
web::json::value TemplateLimitationDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("limitation_name"))] = ModelBase::toJson(m_Limitation_name);
    }
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("consumption_reset_period_days"))] = ModelBase::toJson(m_Consumption_reset_period_days);
    }
    if(m_GoodwillIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("goodwill"))] = ModelBase::toJson(m_Goodwill);
    }
...
void TemplateLimitationDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Limitation_nameIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("limitation_name")), m_Limitation_name));
    }
    if(m_Is_adjustableIsSet)
    {
    ...
    if(m_Consumption_reset_period_daysIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("consumption_reset_period_days")), m_Consumption_reset_period_days));
    }
    if(m_GoodwillIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("goodwill")), m_Goodwill));
    }
    if(m_Enforce_limitIsSet)
    {
