...
web::json::value TemplateLimitationDto::toJson() const
{
    ...
    if(m_Enforce_limitIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("enforce_limit"))] = ModelBase::toJson(m_Enforce_limit);
    }
    if(m_User_provisioningIsSet)
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("user_provisioning"))] = ModelBase::toJson(m_User_provisioning);
    }
    ...
    if(m_Alerts.has_value())
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("alerts"))] = ModelBase::toJson(m_Alerts.get());
    }
...
bool TemplateLimitationDto::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("enforce_limit"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("enforce_limit")));
        if(!fieldValue.is_null())
        {
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("user_provisioning"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("user_provisioning")));
        if(!fieldValue.is_null())
        {
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("consumption_balance_mode"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("consumption_balance_mode")));
        if(!fieldValue.is_null())
        {
...
void TemplateLimitationDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Enforce_limitIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("enforce_limit")), m_Enforce_limit));
    }
    if(m_User_provisioningIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("user_provisioning")), m_User_provisioning));
    }
    if(m_Consumption_balance_modeIsSet)
    {
    ...
    if(m_Alerts.has_value())
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("alerts")), m_Alerts.get()));
    }
}
...
bool TemplateLimitationDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("enforce_limit"))))
    {
        bool refVal_setEnforceLimit;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("enforce_limit"))), refVal_setEnforceLimit );
        setEnforceLimit(refVal_setEnforceLimit);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("user_provisioning"))))
    {
        bool refVal_setUserProvisioning;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("user_provisioning"))), refVal_setUserProvisioning );
        setUserProvisioning(refVal_setUserProvisioning);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("consumption_balance_mode"))))
    {
        std::shared_ptr<ConsumptionBalanceMode> refVal_setConsumptionBalanceMode;
