...
web::json::value UsageHeartbeatValueDto::toJson() const
{
    ...
    if(m_Usage_feature_idIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("usage_feature_id"))] = ModelBase::toJson(m_Usage_feature_id);
    }
    if(m_Usage_module_id.has_value())
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("usage_module_id"))] = ModelBase::toJson(m_Usage_module_id.get());
    }
...
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("usage_feature_id"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("usage_feature_id")));
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("usage_module_id"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("usage_module_id")));
        if(!fieldValue.is_null())
        {
...
void UsageHeartbeatValueDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Usage_feature_idIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("usage_feature_id")), m_Usage_feature_id));
    }
    if(m_Usage_module_id.has_value())
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("usage_module_id")), m_Usage_module_id.get()));
    }
    if(m_Timestamp_utc.has_value())
    {
...
bool UsageHeartbeatValueDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("usage_feature_id"))))
    {
        utility::string_t refVal_setUsageFeatureId;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("usage_feature_id"))), refVal_setUsageFeatureId );
        setUsageFeatureId(refVal_setUsageFeatureId);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("usage_module_id"))))
    {
        utility::string_t refVal_setUsageModuleId;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("usage_module_id"))), refVal_setUsageModuleId );
        setUsageModuleId(refVal_setUsageModuleId);
    }
...
{
    return m_Usage_module_id.has_value();
}

void UsageHeartbeatValueDto::unsetUsage_module_id()
{
    m_Usage_module_id.reset();
}
