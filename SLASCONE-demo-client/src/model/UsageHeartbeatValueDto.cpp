...
web::json::value UsageHeartbeatValueDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("usage_module_id"))] = ModelBase::toJson(m_Usage_module_id);
    }
...
void UsageHeartbeatValueDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Usage_module_idIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("usage_module_id")), m_Usage_module_id));
    }
    if(m_Timestamp_utcIsSet)
    {
