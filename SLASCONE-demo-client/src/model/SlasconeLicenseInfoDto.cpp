...
web::json::value SlasconeLicenseInfoDto::toJson() const
{
    ...
    if(m_Slascone_licensing_stateIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("slascone_licensing_state"))] = ModelBase::toJson(m_Slascone_licensing_state);
    }
    ...
    if(m_Slascone_license_infoIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("slascone_license_info"))] = ModelBase::toJson(m_Slascone_license_info);
    }
...
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("slascone_licensing_state"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("slascone_licensing_state")));
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("slascone_license_info"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("slascone_license_info")));
        if(!fieldValue.is_null())
        {
...
void SlasconeLicenseInfoDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Slascone_licensing_stateIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("slascone_licensing_state")), m_Slascone_licensing_state));
    }
    if(m_Error_message.has_value())
    {
    ...
    if(m_Slascone_license_infoIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("slascone_license_info")), m_Slascone_license_info));
    }
}
...
bool SlasconeLicenseInfoDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("slascone_licensing_state"))))
    {
        std::shared_ptr<SlasconeLicensingState> refVal_setSlasconeLicensingState;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("slascone_licensing_state"))), refVal_setSlasconeLicensingState );
        setSlasconeLicensingState(refVal_setSlasconeLicensingState);
    }
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("slascone_license_info"))))
    {
        std::shared_ptr<LicenseInfoDto> refVal_setSlasconeLicenseInfo;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("slascone_license_info"))), refVal_setSlasconeLicenseInfo );
        setSlasconeLicenseInfo(refVal_setSlasconeLicenseInfo);
    }
    return ok;
}
