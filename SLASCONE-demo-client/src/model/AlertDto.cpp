...
web::json::value AlertDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("alert_days"))] = ModelBase::toJson(m_Alert_days);
    }
    if(m_ModeIsSet)
    {   
...
void AlertDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Alert_daysIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("alert_days")), m_Alert_days));
    }
    if(m_ModeIsSet)
    {
