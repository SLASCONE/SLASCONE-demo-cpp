...
web::json::value LicenseLimitationDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("limitation_description"))] = ModelBase::toJson(m_Limitation_description);
    }
    if(m_LimitIsSet)
    {   
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("current_user_transaction_id"))] = ModelBase::toJson(m_Current_user_transaction_id);
    }
...
void LicenseLimitationDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Limitation_descriptionIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("limitation_description")), m_Limitation_description));
    }
    if(m_LimitIsSet)
    {
    ...
    if(m_Current_user_transaction_idIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("current_user_transaction_id")), m_Current_user_transaction_id));
    }
}
