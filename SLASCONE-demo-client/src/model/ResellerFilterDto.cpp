...
web::json::value ResellerFilterDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("tag_ids"))] = ModelBase::toJson(m_Tag_ids);
    }
...
void ResellerFilterDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Tag_idsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("tag_ids")), m_Tag_ids));
    }
    if(m_Start_characterIsSet)
    {
