...
web::json::value SessionDto::toJson() const
{
    ...
    if(m_Session_id.has_value())
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("session_id"))] = ModelBase::toJson(m_Session_id.get());
    }
    if(m_Session_valid_until.has_value())
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("session_valid_until"))] = ModelBase::toJson(m_Session_valid_until.get());
    }
...
void SessionDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Session_id.has_value())
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("session_id")), m_Session_id.get()));
    }
    if(m_Session_valid_until.has_value())
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("session_valid_until")), m_Session_valid_until.get()));
    }
    if(m_Created_date_utcIsSet)
    {
...
{
    return m_Session_valid_until.get();
}
...
{
    return m_Session_valid_until.has_value();
}

void SessionDto::unsetSession_valid_until()
{
    m_Session_valid_until.reset();
}
