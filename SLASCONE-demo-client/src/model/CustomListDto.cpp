...
web::json::value CustomListDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("custom_list_name"))] = ModelBase::toJson(m_Custom_list_name);
    }
    if(m_ElementsIsSet)
    {   
        
        val[utility::conversions::to_string_t(_XPLATSTR("elements"))] = ModelBase::toJson(m_Elements);
    }
...
void CustomListDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Custom_list_nameIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("custom_list_name")), m_Custom_list_name));
    }
    if(m_ElementsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("elements")), m_Elements));
    }
    if(m_Created_date_utcIsSet)
    {
