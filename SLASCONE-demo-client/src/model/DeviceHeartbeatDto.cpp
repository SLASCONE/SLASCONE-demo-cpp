...
web::json::value DeviceHeartbeatDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("heartbeat_type_id"))] = ModelBase::toJson(m_Heartbeat_type_id);
    }
...
void DeviceHeartbeatDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Heartbeat_type_idIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("heartbeat_type_id")), m_Heartbeat_type_id));
    }
    if(m_Heartbeat_typeIsSet)
    {
