...
web::json::value TemplateFeatureDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("feature_name"))] = ModelBase::toJson(m_Feature_name);
    }
...
void TemplateFeatureDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Feature_nameIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("feature_name")), m_Feature_name));
    }
    if(m_Is_adjustableIsSet)
    {
