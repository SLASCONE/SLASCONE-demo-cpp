...
web::json::value SessionRequestDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("checkout_period"))] = ModelBase::toJson(m_Checkout_period);
    }
...
void SessionRequestDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Checkout_periodIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("checkout_period")), m_Checkout_period));
    }
}
