...
web::json::value SessionRequestDto::toJson() const
{
    ...
    if(m_Checkout_period.has_value())
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("checkout_period"))] = ModelBase::toJson(m_Checkout_period.get());
    }
...
bool SessionRequestDto::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("checkout_period"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("checkout_period")));
        if(!fieldValue.is_null())
        {
...
void SessionRequestDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Checkout_period.has_value())
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("checkout_period")), m_Checkout_period.get()));
    }
}
...
bool SessionRequestDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("checkout_period"))))
    {
        double refVal_setCheckoutPeriod;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("checkout_period"))), refVal_setCheckoutPeriod );
        setCheckoutPeriod(refVal_setCheckoutPeriod);
    }
    return ok;
}
...
{
    return m_Checkout_period.has_value();
}

void SessionRequestDto::unsetCheckout_period()
{
    m_Checkout_period.reset();
}
