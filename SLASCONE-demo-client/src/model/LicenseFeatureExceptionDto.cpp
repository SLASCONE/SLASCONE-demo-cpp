...
web::json::value LicenseFeatureExceptionDto::toJson() const
{
    ...
    if(m_End_date_utcIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("end_date_utc"))] = ModelBase::toJson(m_End_date_utc);
    }
    if(m_Temporary_is_activeIsSet)
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("temporary_is_active"))] = ModelBase::toJson(m_Temporary_is_active);
    }
...
bool LicenseFeatureExceptionDto::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("end_date_utc"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("end_date_utc")));
        if(!fieldValue.is_null())
        {
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("temporary_is_active"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("temporary_is_active")));
        if(!fieldValue.is_null())
        {
...
void LicenseFeatureExceptionDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_End_date_utcIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("end_date_utc")), m_End_date_utc));
    }
    if(m_Temporary_is_activeIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("temporary_is_active")), m_Temporary_is_active));
    }
}
...
bool LicenseFeatureExceptionDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("end_date_utc"))))
    {
        utility::datetime refVal_setEndDateUtc;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("end_date_utc"))), refVal_setEndDateUtc );
        setEndDateUtc(refVal_setEndDateUtc);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("temporary_is_active"))))
    {
        bool refVal_setTemporaryIsActive;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("temporary_is_active"))), refVal_setTemporaryIsActive );
        setTemporaryIsActive(refVal_setTemporaryIsActive);
    }
    return ok;
}
