...
web::json::value ResellerLightDto::toJson() const
{
    ...
    {   
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("reseller_number"))] = ModelBase::toJson(m_Reseller_number);
    }
    if(m_EmailIsSet)
    {   
...
void ResellerLightDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Reseller_numberIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("reseller_number")), m_Reseller_number));
    }
    if(m_EmailIsSet)
    {
