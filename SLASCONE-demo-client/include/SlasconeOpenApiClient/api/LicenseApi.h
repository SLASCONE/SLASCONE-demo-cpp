...
public:
    ...
    /// <param name="isvId"></param>
    /// <param name="licenseDto"></param>
    /// <param name="applyTemplateProperties">Set to true to apply template values for any missing properties. (optional, default to false)</param>
    pplx::task<std::shared_ptr<LicenseDto>> updateLicense(
        utility::string_t isvId,
        std::shared_ptr<LicenseDto> licenseDto,
        boost::optional<bool> applyTemplateProperties
    ) const;
    /// <summary>
