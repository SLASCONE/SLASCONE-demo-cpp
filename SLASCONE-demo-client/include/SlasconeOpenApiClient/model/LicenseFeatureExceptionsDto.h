...
public:
    ...
    std::vector<std::shared_ptr<LicenseFeatureExceptionDto>> getExceptions() const;
...
protected:
    ...
    boost::optional<std::vector<std::shared_ptr<LicenseFeatureExceptionDto>>> m_Exceptions;
