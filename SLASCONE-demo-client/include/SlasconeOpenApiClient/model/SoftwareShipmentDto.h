...
protected:
    ...
    utility::string_t m_Version_number;
    bool m_Version_numberIsSet;

    utility::string_t m_Description;
    bool m_DescriptionIsSet;

    utility::string_t m_Download_link;
    bool m_Download_linkIsSet;

    std::vector<std::shared_ptr<SoftwareShipmentPropertyDto>> m_Properties;
