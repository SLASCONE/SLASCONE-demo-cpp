...
public:
    ...
    std::vector<utility::string_t> getCustomerNumberFilter() const;
    ...
    std::vector<utility::string_t> getCustomerTypeFilter() const;
    ...
    std::vector<utility::string_t> getResellerTypeFilter() const;
    ...
    std::vector<utility::string_t> getOperatingSystemFilter() const;
    ...
    std::vector<utility::string_t> getSoftwareVersionFilter() const;
    ...
    std::vector<utility::string_t> getFeatureFilter() const;
...
protected:
    ...
    boost::optional<utility::string_t> m_Key_search;
    ...
    boost::optional<std::vector<utility::string_t>> m_Customer_number_filter;

    boost::optional<std::vector<utility::string_t>> m_Customer_type_filter;

    boost::optional<std::vector<utility::string_t>> m_Reseller_type_filter;

    boost::optional<std::vector<utility::string_t>> m_Template_filter;

    boost::optional<std::vector<utility::string_t>> m_License_type_filter;

    boost::optional<std::vector<utility::string_t>> m_Operating_system_filter;

    boost::optional<std::vector<utility::string_t>> m_Software_version_filter;

    boost::optional<bool> m_Is_software_version_valid;

    boost::optional<std::vector<utility::string_t>> m_Feature_filter;

    boost::optional<bool> m_Is_feature_active;

    boost::optional<utility::datetime> m_Date_filter;

    boost::optional<utility::string_t> m_Date_filter_mode;

    boost::optional<bool> m_Is_normal_token;

    boost::optional<bool> m_Is_goodwill_token;

    boost::optional<bool> m_Is_group_valid;

    boost::optional<bool> m_Is_assigned_token;

    boost::optional<bool> m_Is_suspended_token;

    boost::optional<int32_t> m_Group_count_filter;

    boost::optional<utility::string_t> m_Group_count_mode;
    ...
    boost::optional<std::vector<int32_t>> m_License_tag_filter;

    boost::optional<std::vector<int32_t>> m_Token_tag_filter;

    boost::optional<std::vector<int32_t>> m_Customer_tag_filter;
