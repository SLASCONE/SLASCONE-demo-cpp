...
public:
    ...
    std::vector<std::shared_ptr<SessionDto>> getActiveSessions() const;
...
protected:
    ...
    boost::optional<std::vector<std::shared_ptr<SessionDto>>> m_Active_sessions;

    boost::optional<utility::string_t> m_License_user_group_id;
