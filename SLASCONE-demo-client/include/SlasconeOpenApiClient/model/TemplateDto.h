...
public:
    ...
    std::vector<std::shared_ptr<TemplateFeatureDto>> getFeatures() const;
    bool featuresIsSet() const;
    void unsetFeatures();
    void setFeatures(const std::vector<std::shared_ptr<TemplateFeatureDto>>& value);

    std::vector<std::shared_ptr<TemplateLimitationDto>> getLimitations() const;
    ...
    std::vector<std::shared_ptr<TemplateVariableDto>> getVariables() const;
    bool variablesIsSet() const;
    void unsetVariables();
    void setVariables(const std::vector<std::shared_ptr<TemplateVariableDto>>& value);

    std::vector<std::shared_ptr<TemplateConstrainedVariableDto>> getConstrainedVariables() const;
...
protected:
    ...
    boost::optional<int32_t> m_Free_ride;
    ...
    boost::optional<std::vector<std::shared_ptr<TemplateFeatureDto>>> m_Features;

    boost::optional<std::vector<std::shared_ptr<TemplateLimitationDto>>> m_Limitations;

    boost::optional<std::vector<std::shared_ptr<TemplateVariableDto>>> m_Variables;

    boost::optional<std::vector<std::shared_ptr<TemplateConstrainedVariableDto>>> m_Constrained_variables;
    ...
    boost::optional<int32_t> m_Heartbeat_sampling_rate;
