...
protected:
    ...
    boost::optional<utility::string_t> m_Short_description;

    boost::optional<utility::string_t> m_Minimum_software_release_id;

    boost::optional<std::vector<std::shared_ptr<SoftwareReleaseLimitationDto>>> m_Software_release;
    ...
    boost::optional<utility::string_t> m_License_file_name;
    ...
    boost::optional<int32_t> m_Maximum_inactive_days;
