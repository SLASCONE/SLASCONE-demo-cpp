...
public:
    ...
    std::vector<std::shared_ptr<DeviceAnalyticalHeartbeatDto>> getDeviceAnalyticalHeartbeats() const;
...
protected:
    ...
    boost::optional<utility::string_t> m_Device_name;

    boost::optional<utility::string_t> m_Device_description;
    ...
    boost::optional<std::vector<std::shared_ptr<DeviceAnalyticalHeartbeatDto>>> m_Device_analytical_heartbeats;

    boost::optional<utility::string_t> m_Software_version;

    boost::optional<utility::string_t> m_Operating_system;
    ...
    boost::optional<utility::datetime> m_Suspended_until_utc;
