...
public:
    HeartBeatMode();
    HeartBeatMode(utility::string_t str);
    ...
    protected:
        ...
        std::map<eHeartBeatMode,utility::string_t> enumToStrMap = {
        { eHeartBeatMode::_1, _XPLATSTR("_1") },
        { eHeartBeatMode::_2, _XPLATSTR("_2") }
};
        std::map<utility::string_t,eHeartBeatMode> strToEnumMap = {
        { _XPLATSTR("_1"), eHeartBeatMode::_1 },
        { _XPLATSTR("_2"), eHeartBeatMode::_2 }
};
