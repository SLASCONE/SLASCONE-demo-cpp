...
public:
    ...
    bool isIsNewerSoftwareShipmentAvailable() const;
    bool isNewerSoftwareShipmentAvailableIsSet() const;
    void unsetIs_newer_software_shipment_available();
    void setIsNewerSoftwareShipmentAvailable(bool value);

    std::shared_ptr<SoftwareShipmentDto> getLatestSoftwareShipment() const;
    bool latestSoftwareShipmentIsSet() const;
    void unsetLatest_software_shipment();
    void setLatestSoftwareShipment(const std::shared_ptr<SoftwareShipmentDto>& value);
    ...
    std::vector<std::shared_ptr<ProvisioningFeatureDto>> getFeatures() const;
    bool featuresIsSet() const;
    void unsetFeatures();
    void setFeatures(const std::vector<std::shared_ptr<ProvisioningFeatureDto>>& value);

    std::vector<std::shared_ptr<ProvisioningLimitationDto>> getLimitations() const;
    ...
    std::vector<std::shared_ptr<ProvisioningVariableDto>> getVariables() const;
    bool variablesIsSet() const;
    void unsetVariables();
    void setVariables(const std::vector<std::shared_ptr<ProvisioningVariableDto>>& value);

    std::vector<std::shared_ptr<ProvisioningConstrainedVariableDto>> getConstrainedVariables() const;
...
protected:
    ...
    boost::optional<utility::string_t> m_License_key;
    ...
    boost::optional<utility::string_t> m_Template_name;
    ...
    bool m_Is_newer_software_shipment_available;
    bool m_Is_newer_software_shipment_availableIsSet;

    std::shared_ptr<SoftwareShipmentDto> m_Latest_software_shipment;
    bool m_Latest_software_shipmentIsSet;

    boost::optional<int32_t> m_Session_period;

    boost::optional<int32_t> m_Heartbeat_period;

    boost::optional<int32_t> m_Freeride;

    bool m_Enforce_software_version_upgrade;
    bool m_Enforce_software_version_upgradeIsSet;

    boost::optional<std::vector<std::shared_ptr<ProvisioningFeatureDto>>> m_Features;

    boost::optional<std::vector<std::shared_ptr<ProvisioningLimitationDto>>> m_Limitations;

    boost::optional<std::vector<std::shared_ptr<ProvisioningVariableDto>>> m_Variables;

    boost::optional<std::vector<std::shared_ptr<ProvisioningConstrainedVariableDto>>> m_Constrained_variables;
