...
public:
    ProvisioningMode();
    ProvisioningMode(utility::string_t str);
    ...
    protected:
        ...
        std::map<eProvisioningMode,utility::string_t> enumToStrMap = {
        { eProvisioningMode::_0, _XPLATSTR("_0") },
        { eProvisioningMode::_1, _XPLATSTR("_1") }
};
        std::map<utility::string_t,eProvisioningMode> strToEnumMap = {
        { _XPLATSTR("_0"), eProvisioningMode::_0 },
        { _XPLATSTR("_1"), eProvisioningMode::_1 }
};
