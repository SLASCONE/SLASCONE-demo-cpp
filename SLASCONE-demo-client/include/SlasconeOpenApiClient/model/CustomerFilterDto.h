...
protected:
    ...
    boost::optional<int32_t> m_Page_size;

    boost::optional<utility::string_t> m_Search_text;

    boost::optional<utility::string_t> m_Plz_query;

    boost::optional<std::vector<utility::string_t>> m_Customer_types;

    boost::optional<std::vector<utility::string_t>> m_Reseller_types;

    boost::optional<std::vector<int32_t>> m_Tags;

    boost::optional<utility::string_t> m_Start_character;
