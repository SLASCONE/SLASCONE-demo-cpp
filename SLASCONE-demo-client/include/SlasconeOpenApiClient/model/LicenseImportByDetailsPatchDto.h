...
/*
 * LicenseImportByDetailsPatchDto.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_LicenseImportByDetailsPatchDto_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_LicenseImportByDetailsPatchDto_H_
...
class  LicenseImportByDetailsPatchDto
    : public ModelBase
{
public:
    LicenseImportByDetailsPatchDto();
    virtual ~LicenseImportByDetailsPatchDto();
    ...
    /////////////////////////////////////////////
    /// LicenseImportByDetailsPatchDto members
    ...
    std::vector<std::shared_ptr<LicenseImportLimitationDto>> getLicenseLimitations() const;
    ...
    std::vector<std::shared_ptr<LicenseImportVariableDto>> getLicenseVariables() const;
    ...
    std::vector<std::shared_ptr<LicenseImportConstrainedVariableDto>> getLicenseConstrainedVariables() const;
...
protected:
    ...
    boost::optional<utility::string_t> m_r_template;
    ...
    boost::optional<std::vector<utility::string_t>> m_License_features;

    boost::optional<std::vector<std::shared_ptr<LicenseImportLimitationDto>>> m_License_limitations;

    boost::optional<std::vector<std::shared_ptr<LicenseImportVariableDto>>> m_License_variables;

    boost::optional<std::vector<std::shared_ptr<LicenseImportConstrainedVariableDto>>> m_License_constrained_variables;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_LicenseImportByDetailsPatchDto_H_ */
