...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_LimitationDto_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_LimitationDto_H_
...
public:
    ...
    bool isIsAggregatable() const;
    bool isAggregatableIsSet() const;
    void unsetIs_aggregatable();
    void setIsAggregatable(bool value);
...
protected:
    ...
    bool m_Is_aggregatable;
    bool m_Is_aggregatableIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_LimitationDto_H_ */
