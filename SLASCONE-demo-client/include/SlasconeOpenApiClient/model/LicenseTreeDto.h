...
public:
    ...
    std::vector<std::shared_ptr<TagAssignmentDto>> getTagAssignments() const;
    ...
    utility::string_t getResellerEmail() const;
    bool resellerEmailIsSet() const;
    void unsetReseller_email();
    void setResellerEmail(const utility::string_t& value);

    utility::string_t getResellerName() const;
    bool resellerNameIsSet() const;
    void unsetReseller_name();
    void setResellerName(const utility::string_t& value);

    utility::string_t getResellerType() const;
    bool resellerTypeIsSet() const;
    void unsetReseller_type();
    void setResellerType(const utility::string_t& value);
...
protected:
    ...
    boost::optional<utility::string_t> m_Software_release;

    boost::optional<utility::string_t> m_License_type_name;
    ...
    boost::optional<int32_t> m_Active_users;

    boost::optional<int32_t> m_Active_floating_tokens;
    ...
    boost::optional<bool> m_Has_consumption_heartbeats;
    ...
    boost::optional<std::vector<std::shared_ptr<TagAssignmentDto>>> m_Tag_assignments;

    boost::optional<utility::string_t> m_Reseller_id;

    boost::optional<utility::string_t> m_Reseller_number;

    boost::optional<utility::string_t> m_Reseller_email;

    boost::optional<utility::string_t> m_Reseller_name;

    boost::optional<utility::string_t> m_Reseller_type;
