...
public:
    ...
    std::vector<utility::string_t> getToEmail() const;
...
protected:
    ...
    boost::optional<utility::string_t> m_From_email;

    boost::optional<utility::string_t> m_Password;

    boost::optional<std::vector<utility::string_t>> m_To_email;

    boost::optional<utility::string_t> m_Smtp_client;

    boost::optional<int32_t> m_Smtp_port;

    boost::optional<utility::string_t> m_Acs_sender_domain;

    boost::optional<utility::string_t> m_Acs_sender_username;
