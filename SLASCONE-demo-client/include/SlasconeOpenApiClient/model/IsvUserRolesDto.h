...
public:
    ...
    std::vector<std::shared_ptr<ResellerPortalRoleDto>> getResellerPortalRoles() const;
    ...
    std::vector<std::shared_ptr<CustomerPortalRoleDto>> getCustomerPortalRoles() const;
...
protected:
    ...
    boost::optional<utility::string_t> m_IsvName;
    ...
    boost::optional<std::vector<std::shared_ptr<ResellerPortalRoleDto>>> m_ResellerPortalRoles;

    boost::optional<std::vector<std::shared_ptr<CustomerPortalRoleDto>>> m_CustomerPortalRoles;
