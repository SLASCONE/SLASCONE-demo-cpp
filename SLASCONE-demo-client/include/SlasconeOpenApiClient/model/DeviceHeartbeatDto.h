...
protected:
    ...
    boost::optional<utility::string_t> m_Ip_address;
    ...
    boost::optional<utility::string_t> m_Latitude;

    boost::optional<utility::string_t> m_Longitude;
    ...
    boost::optional<utility::string_t> m_Heartbeat_type_id;
    ...
    boost::optional<utility::string_t> m_Group_id;
